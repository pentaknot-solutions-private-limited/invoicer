...
@Component({
    selector: '[vsa-date-time-calendar-body]',
...
export class OwlCalendarBodyComponent implements OnInit {
     ...
     */
    public isSelected(value: number): boolean | any {
     ...
     * */
    public isInRange(value: number): boolean | any {
        if (this.isInRangeMode) {
            const fromValue = this.selectedValues[0];
            const toValue = this.selectedValues[1];
     ...
     * */
    public isRangeFrom(value: number): boolean | any {
        if (this.isInRangeMode) {
            const fromValue = this.selectedValues[0];
     ...
     * */
    public isRangeTo(value: number): boolean | any {
        if (this.isInRangeMode) {
            const toValue = this.selectedValues[1];
