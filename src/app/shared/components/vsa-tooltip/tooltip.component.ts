...
export class TooltipComponent {
    ...
    @HostBinding('style.top') hostStyleTop: string | any;
    @HostBinding('style.left') hostStyleLeft: string | any;
    @HostBinding('style.z-index') hostStyleZIndex: number | any;
    @HostBinding('style.transition') hostStyleTransition: string | any;
    @HostBinding('style.width') hostStyleWidth: string | any;
    @HostBinding('style.max-width') hostStyleMaxWidth: string | any;
    @HostBinding('style.pointer-events') hostStylePointerEvents: string | any;
    @HostBinding('class.tooltip-show') hostClassShow: boolean | any;
    @HostBinding('class.no-padding') hostClassNoPadding: boolean | any;
    @HostBinding('class.tooltip-shadow') hostClassShadow: boolean | any;
    @HostBinding('class.tooltip-light') hostClassLight: boolean | any;
    ...
    setStyles() {
        ...
        this.hostClassNoPadding = this.options['no-padding'];
