...
@Component({
    selector: 'vsa-date-time-year-view',
...
export class OwlYearViewComponent<T>
    ...
    private _months: CalendarCell[][] | any;
    get months() {
        return this._months;
    }
    ...
    public todayMonth: number | null | any;
     ...
     */
    private getMonthInCurrentYear(date: T | null | any): number | any {
     ...
     */
    private getValidDate(obj: any): T | null | any {
