...
export class OwlDateTimeComponent<T> extends OwlDateTime<T>
    ...
    private _startAt: T | null | any;
    @Input()
    get startAt(): T | null | any {
     ...
     * */
    @Input()
    public scrollStrategy: ScrollStrategy | any;
    ...
    > | any;
    private pickerContainer: OwlDateTimeContainerComponent<T> | any;
    private popupRef: OverlayRef | any;
    private dialogRef: OwlDialogRef<OwlDateTimeContainerComponent<T>> | any;
    private dtInputSub = Subscription.EMPTY;
    private hidePickerStreamSub: any = Subscription.EMPTY;
    private confirmSelectedStreamSub: any = Subscription.EMPTY;
    private pickerOpenedStreamSub: any = Subscription.EMPTY;

    /** The element that was focused before the date time picker was opened. */
    private focusedElementBeforeOpen: HTMLElement | null = null;

    private _dtInput: OwlDateTimeInputDirective<T> | any;
    get dtInput() {
    ...
    public open(): void {
        ...
        this.pickerContainer.dateChange.subscribe(
            (res: any) => {
                this.dateSelected.emit(res)
            }
        );
    }
