...
@Component({
    selector: 'vsa-date-time-multi-year-view',
...
export class OwlMultiYearViewComponent<T> implements OnInit, AfterContentInit {
    ...
    private _pickerMoment: T | null | any;
    @Input()
    get pickerMoment() {
    ...
    private _todayYear: number | any;
    get todayYear(): number {
        return this._todayYear;
    }

    private _years: CalendarCell[][] | any;
    get years() {
        return this._years;
    }

    private _selectedYears: number[] | any;
    ...
    @ViewChild(OwlCalendarBodyComponent, { static: true }) calendarBodyElm: OwlCalendarBodyComponent | any;
