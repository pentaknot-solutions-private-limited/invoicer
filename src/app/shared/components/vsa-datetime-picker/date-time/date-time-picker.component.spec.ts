    ...
    describe('with OwlNativeDateTimeModule', () => {
        describe('standard DateTimePicker', () => {
            ...
            it('should NOT open dateTimePicker if it is disabled', () => {
                ...
                expect(
                    document.querySelector('vsa-date-time-container')
                ).toBeNull();
            ...
            it('input should aria-owns vsa-date-time-container after opened in popup mode', fakeAsync(() => {
                ...
                expect((ownedElement as Element).tagName.toLowerCase()).toBe(
                    'vsa-date-time-container'
                );
            }));

            it('input should aria-owns vsa-date-time-container after opened in dialog mode', fakeAsync(() => {
                testComponent.pickerMode = 'dialog';
                fixture.detectChanges();
...
@Component({
    template: `
        ...
        <vsa-date-time [opened]="opened"
                       [disabled]="disabled"
                       [pickerType]="pickerType"
                       [pickerMode]="pickerMode" #dt></vsa-date-time>
    `
})
...
@Component({
    template: `
        ...
        <vsa-date-time [startAt]="startAt"
                       [pickerType]="pickerType" #dt></vsa-date-time>
    `
})
...
@Component({
    template: `
        ...
        <input [owlDateTime]="dt">
        <vsa-date-time #dt></vsa-date-time>
    `
})
...
@Component({
    template: `
        <input [owlDateTime]="dt" [value]="date">
        <vsa-date-time #dt [startAt]="startDate"></vsa-date-time>
    `
})
...
@Component({
    template: `
        <input [owlDateTime]="dt" [value]="date">
        <vsa-date-time #dt [startView]="startView"
                       (monthSelected)="onMonthSelection()"
                       (yearSelected)="onYearSelection()"></vsa-date-time>
    `
})
...
@Component({
    template: `
        <input [(ngModel)]="date" [min]="min" [max]="max"
               [owlDateTime]="dt"
               [owlDateTimeTrigger]="dt">
        <vsa-date-time [showSecondsTimer]="true" #dt></vsa-date-time>
    `
})
...
@Component({
    ...
    <vsa-date-time #dt [startAt]="startAt"></vsa-date-time>
  `
})
...
@Component({
    ...
    <vsa-date-time (afterPickerOpen)="openedSpy()" (afterPickerClosed)="closedSpy()" #dt></vsa-date-time>
  `
})
