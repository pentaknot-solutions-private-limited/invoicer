...
@Component({
    selector: 'vsa-date-time-calendar',
...
export class OwlCalendarComponent<T>
    ...
    @Input()
    get minDate(): T | null | any {
        return this._minDate;
    }

    set minDate(value: T | null | any) {
    ...
    get periodButtonText(): string {        
        return this.isMonthView
            ? this.dateTimeAdapter.format(
                  this.pickerMoment,
                  this.dateTimeFormats.monthYearA11yLabel //monthYearLabel for Short Month
              )
    ...
    get prevButtonLabel(): string | any {
    ...
    get nextButtonLabel(): string | any {
        if (this._currentView === 'month') {
    ...
    private _currentView: 'month' | 'year' | 'multi-years' | any;
