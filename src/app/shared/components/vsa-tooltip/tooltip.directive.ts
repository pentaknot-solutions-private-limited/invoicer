...
export class TooltipDirective {
    ...
    hideTimeoutId: number | any;
    destroyTimeoutId: number | any;
    hideAfterClickTimeoutId: number | any;
    createTimeoutId: number | any;
    showTimeoutId: number | any;
    componentRef: any;
    elementPosition: any;
    _showDelay: any = 0;
    ...
    _options: any = {};
    _defaultOptions: any;
    _destroyDelay: number | any;
    componentSubscribe: any;

    @Input('options') set options(value: TooltipOptions | any) {
    ...
    @Input('tooltip') tooltipValue: string | any;
    @Input('placement') placement: string | any;
    @Input('autoPlacement') autoPlacement: boolean | any;
    @Input('content-type') contentType: string | any;
    @Input('hide-delay-mobile') hideDelayMobile: number | any;
    @Input('hideDelayTouchscreen') hideDelayTouchscreen: number | any;
    @Input('z-index') zIndex: number | any;
    @Input('animation-duration') animationDuration: number | any;
    @Input('trigger') trigger: string | any;
    @Input('tooltip-class') tooltipClass: string | any;
    @Input('display') display: boolean | any;
    @Input('display-mobile') displayMobile: boolean | any;
    @Input('displayTouchscreen') displayTouchscreen: boolean | any;
    @Input('shadow') shadow: boolean | any;
    @Input('theme') theme: boolean | any;
    @Input('offset') offset: number | any;
    @Input('width') width: number | any;
    @Input('max-width') maxWidth: number | any;
    @Input('id') id: any;
    @Input('show-delay') showDelay: number | any;
    @Input('hide-delay') hideDelay: number | any;
    @Input('hideDelayAfterClick') hideDelayAfterClick: number | any;
    @Input('pointerEvents') pointerEvents: 'auto' | 'none' | any;
    @Input('position') position: {top: number, left: number} | any;
    ...
    renameProperties(options: TooltipOptions | any) {
