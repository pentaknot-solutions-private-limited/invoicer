...
@Component({
    template: `
        <vsa-date-time-calendar
                [(selected)]="selected"
                [selectMode]="selectMode"
                [pickerMoment]="pickerMoment"
                (monthSelected)="selectedMonth=$event"
                (yearSelected)="selectedYear=$event"></vsa-date-time-calendar>
    `
})
...
@Component({
    template: `
        <vsa-date-time-calendar [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [minDate]="minDate"
                                [maxDate]="maxDate"></vsa-date-time-calendar>
    `
})
...
@Component({
    template: `
        <vsa-date-time-calendar [(selected)]="selected"
                                [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [dateFilter]="dateFilter"></vsa-date-time-calendar>
    `
})
