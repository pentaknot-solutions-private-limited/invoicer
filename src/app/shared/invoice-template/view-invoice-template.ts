                    ...
                    stack: [
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        ...
                                        {
                                            text: invoiceData.saleDetails?.invoiceNumber ? invoiceData.saleDetails?.invoiceNumber : '-',
                                            alignment: "right"
                                        }
                                    ],
                                    [
                                        ...
                                        {
                                            text: invoiceData.saleDetails?.invoiceDate ? moment(invoiceData.saleDetails?.invoiceDate).format("DD MMM, YYYY") : '-',
                                            alignment: "right"
                                        }
                                    ]
                                ]
                        ...
                        },
                        {
                            stack: [
                                ...
                                {
                                    text: invoiceData?.customer?.companyName ? invoiceData?.customer?.companyName : invoiceData?.customer?.firstName ? `${invoiceData?.customer?.firstName} ${invoiceData?.customer?.middleName} ${invoiceData?.customer?.lastName}` : "-",
                                    bold: true,
                                    fontSize: 10,
                                    color: "191919"
                                },
                                {
                                    text: invoiceData?.customer?.addressLine1 ? invoiceData?.customer?.addressLine1 : '-'
                                },
                                {
                                    text: invoiceData?.customer?.addressLine2 ? invoiceData?.customer?.addressLine2 : '-'
                                },
                                {
                                    text: invoiceData?.customer?.city ? `${invoiceData?.customer?.city} - ${invoiceData?.customer?.pincode}` : '-'
                                },
                                {
                                    text: `PAN: ${invoiceData?.customer?.panNo ? invoiceData?.customer?.panNo : '-'}`
                                },
                                {
                                    text: `PHONE: ${invoiceData?.customer?.panNo ? invoiceData?.customer?.phone : '-'}`
                                }
                            ],
                            fontSize: 8,
                            color: '#5c5c5c',
    ...
    private createInvoiceTable(invoiceData: invoiceDataModel) {
        ...
        const template = {
            ...
            layout: {
                ...
                fillColor: function (i, node) { return bgColor; }
            },
            fontSize: 10,
            width: '100%',
            margin: [20, 10, 20, 0]
                    ...
                    stack: [
                        ...
                        },
                        {
                            stack: [
                                ...
                                { text: `Customer Notes & Remark Comes here..` },
                            ],
                            fontSize: 8,
                            margin: [0,0,0,10]
                        }
                    ...
                    columns: [
                        {
                            stack: [
                                ...
                                { alignment: `justify`, text: `We hereby declare that this Vehicle is non accidental, non flooded, and the mileage on the cluster is genuine.` },
                            ],
                            width: `50%`
                        },
                        {
