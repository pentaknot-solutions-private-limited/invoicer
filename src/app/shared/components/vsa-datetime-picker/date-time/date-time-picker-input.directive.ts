...
export class OwlDateTimeInputDirective<T>
    ...
    private _dateTimeFilter: ((date: T | null) => boolean) | any;
    get dateTimeFilter() {
    ...
    private _value: T | null | any;
    @Input()
    get value() {
        return this._value;
    }

    set value(value: T | null | any) {
    ...
    private _values: T[] | any = [];
    @Input()
    get values() {
        return this._values;
    }

    set values(values: T[] | any) {
        if (values && values.length > 0) {
            this._values = values.map((v: any) => {
    ...
    /** The date-time-picker that this input is associated with. */
    public dtPicker: OwlDateTimeComponent<T> | any;
    ...
    get minIso8601(): string | any {
        return this.min ? this.dateTimeAdapter.toIso8601(this.min) : null;
    }

    get maxIso8601(): string | any {
    ...
    public ngOnInit(): void {
        if (!this.dtPicker) {
            throw Error(
                `OwlDateTimePicker: the picker input doesn't have any associated vsa-date-time component`
            );
        }
    }
    ...
    public validate(c: AbstractControl): { [key: string]: any } | any {
     ...
     */
    private changeInputInSingleMode(inputValue: string | any): void {
     ...
     */
    private changeInputInRangeFromToMode(inputValue: string | any): void {
        let originalValue =
            this._selectMode === 'rangeFrom'
                ? this._values[0]
                : this._values[1];
    ...
    private changeInputInRangeMode(inputValue: string): void {
        ...
        let fromString: any = selecteds[0];
        let toString: any = selecteds[1];
