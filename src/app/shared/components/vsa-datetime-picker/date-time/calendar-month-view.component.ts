...
@Component({
    selector: 'vsa-date-time-month-view',
...
export class OwlMonthViewComponent<T>
     ...
     * */
    @Input()
    hideOtherMonths: boolean | any = false;
    ...
    set selecteds(values: T[]) {
        this._selecteds = values.map((v: any) => {
    ...
    private _pickerMoment: T | any;
    @Input()
    get pickerMoment() {
        return this._pickerMoment;
    }

    set pickerMoment(value: T | any) {
     ...
     * */
    private _dateFilter: ((date: T) => boolean) | any;
    @Input()
    get dateFilter() {
    ...
    private _weekdays: Array<{ long: string; short: string; narrow: string }> | any;
    get weekdays() {
        return this._weekdays;
    }

    private _days: CalendarCell[][] | any;
    get days() {
        return this._days;
    }

    get activeCell(): number | any {
    ...
    private firstDateOfMonth: T | any;

    private localeSub: Subscription = Subscription.EMPTY;

    private initiated = false;

    private dateNames: string[] | any;

    /**
     * The date of the month that today falls on.
     * */
    public todayDate: number | null | any;

    /**
     * An array to hold all selectedDates' value
     * the value is the day number in current month
     * */
    public selectedDates: number[] | any = [];

    // the index of cell that contains the first date of the month
    public firstRowOffset: number | any;
    ...
    calendarBodyElm: OwlCalendarBodyComponent | any;
